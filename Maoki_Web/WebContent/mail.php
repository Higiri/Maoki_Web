...
<head>
  ...
  <!-- Bootstrap (windyakin/Honoka) -->
  <link href="./css/bootstrap.min.css" rel="stylesheet">
  <!-- Bootstrap v4.4 Grid cards -->
  ...
  <!-- Bootstrap Icon (Iconicのアイコン)-->
  <link href="./font/css/open-iconic-bootstrap.css" rel="stylesheet">
  <!-- Font Awesomeのアイコン -->
  <script src="https://kit.fontawesome.com/9938a3005f.js" crossorigin="anonymous"></script>
  <!-- トップへ戻るJS -->
...
<body>
  ...
  <div class="container">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Mailform</li>
    </ul>
    <?php if($empty_flag == 1){ ?>
    <div class="alert alert-danger" role="alert">
      <h4 class="alert-heading mt-2">エラー</h4>
      <?php echo $errm; ?>
    </div>
    <input type="button" class="btn btn-primary" value=" 前画面に戻る " onClick="history.back()">
    <?php }else{ ?>
    <div class="alert alert-info" role="alert">
      <h4 class="alert-heading mt-2">確認画面</h4>
    ...
    <form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
      ...
      <div class="text-center">
        ...
        <input type="submit" class="btn btn-success btn-lg" value="　送信する　">
        <input type="button" class="btn btn-primary btn-lg" value="前画面に戻る" onClick="history.back()">
      </div>
    </form>
    <?php } ?>
  </div>
